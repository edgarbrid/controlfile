        ...
        <div id="wrapper">
            ...
            <div class="sidebar-collapse menu-scroll">
                <ul id="side-menu" class="nav">
                    ...
                    <li class="active"><a href="{{{action('AdminController@getHistorial')}}}"><i class="fa fa-tachometer fa-fw">
                        <div class="icon-bg bg-orange"></div>
                    </i><span class="menu-title">Inicio</span></a></li>
                    <li><a href="{{action('AdminController@getIndex')}}"><i class="fa fa-calendar fa-fw">
                        <div class="icon-bg bg-red"></div>
                    </i><span class="menu-title">Ajustes</span></a>
